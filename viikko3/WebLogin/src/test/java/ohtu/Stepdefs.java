...
public class Stepdefs {
    ...
    public void invalidUsernameAndPasswordAreGiven(String username, String password) {
        createUser(username, password, password);
    }
    ...
    @When("a valid username {string} and password {string} and mismatching password {string} confirmation are entered")
    public void validUsernameAndMismatchingPasswordAreGiven(String username, String password1, String password2) {
        createUser(username, password1, password2);
    }

    @Given("user with username {string} with password {string} is successfully created")
    public void userCreatedSuccessfully(String username, String password) {
        newIsSelected();
        createUser(username, password, password);
    }

    @Given("user with username {string} and password {string} is tried to be created")
    public void userCreatedUnsuccessfully(String username, String password) {
        newIsSelected();
        createUser(username, password, password);
    }
